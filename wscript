...
def check(bld):
    ...
    if env['CXX']:
        ...
        retval2 = subprocess.Popen([env['PYTHON'], 'tests/footest.py', '1'] + verbosity).wait()
    else:
    ...
    if env['ENABLE_PYGCCXML']:
        ...
        retval3 = subprocess.Popen([env['PYTHON'], 'tests/footest.py', '2'] + verbosity).wait()

        print "Running module generated by automatically generated python script unit tests (module foo3)..."
        retval3b = subprocess.Popen([env['PYTHON'], 'tests/footest.py', '3'] + verbosity).wait()

        print "Running module generated by generated and split python script unit tests  (module foo4)..."
        retval3c = subprocess.Popen([env['PYTHON'], 'tests/footest.py', '4'] + verbosity).wait()

        print "Running semi-automatically scanned c-hello module ('hello')..."
        retval4 = subprocess.Popen([env['PYTHON'], 'tests/c-hello/hellotest.py'] + verbosity).wait()
    else:
