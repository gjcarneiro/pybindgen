...
4. (optional) GCCXML and [PyGCCXML](http://www.language-binding.net/pygccxml/download.html)
...
1. ./waf configure
   - optionally you may add the option --prefix /foo/bar 
    To select a non-defaul python version, use the PYTHON environment variable, e.g.:
...
1. [API docs (with introductory tutorial)](http://pybindgen.readthedocs.org/en/latest/): 
